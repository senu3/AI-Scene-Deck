...
このフォルダは「完了済み」「中止」「履歴保持のみ」のノートを保管します。
...
- `docs/notes/archive/gate9-thumbnail-unification-plan-implemented-2026-02-19.md`
...
- 実装済みで更新頻度が低いものはアーカイブへ移動する。
- 参照が必要な場合は、現行ノート側からリンクを張る。
